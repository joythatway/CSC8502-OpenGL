...
Mesh* Mesh::GenertateQuad() {
	...
	m->normals = new Vector3[m->numVertices];//tu 13
	m->tangents = new Vector4[m->numVertices];//tu 13

	for (int i = 0; i < 4; ++i) {//in tu 13: i++ become ++i
		m->colours[i] = Vector4(1.0f, 1.0f, 1.0f, 1.0f);
		m->normals[i] = Vector3(0.0f, 0.0f, -1.0f);//tu 13
		m->tangents[i] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);//tu 13
	}
